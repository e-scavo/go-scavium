...
var (
	...
	TestnetGenesisHash = common.HexToHash("0xe9af327e2eb5b1b2b9f40f9183ec1ab5135e9f136954f426977b0c195c2af686")
)
...
var (
	...
	MainnetChainConfig = &ChainConfig{
		ChainID:             big.NewInt(836765867385770),
	...
	TestnetChainConfig = &ChainConfig{
		ChainID:             big.NewInt(836765867385771),
		HomesteadBlock:      big.NewInt(0),
		DAOForkBlock:        nil,
		DAOForkSupport:      true,
		EIP150Block:         big.NewInt(0),
